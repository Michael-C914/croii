...
export default function Example() {
  ...
  const [formValuesJuridic, setFormValuesJuridic] = useState({
    "RUC": "",
    "name": "",
    "manager": "",
  });

  const [formValuesNatural, setFormValuesNatural] = useState({
    "DNI": "",
    "first_name": "",
    "last_name": "",
  });
  ...
  const handleOnChangeUserJuridic = ({ target }) => {
    setFormValuesJuridic({
      ...formValuesJuridic,
      [target.name]: target.value
    })
  }

  const handleOnChangeUserNatural = ({ target }) => {
    setFormValuesNatural({
      ...formValuesNatural,
      [target.name]: target.value
    })
  }
